    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        Todo.findById(hexId).then((todo) => {
          // expect(todo).toNotExist(); // deprecated
...
describe('PATCH /todos/:id', () => {
  ...
  it('should clear completeAt when todo is not completed', (done) => {
    var hexId = todos[1]._id.toHexString();
    var text = 'This is a Patch test 2';
...
describe('POST /users', () => {
  it('should create a user', (done) => {
    ...
    request(app)
      ...
      .expect(200)
      .expect((res) => {
        // expect(res.headers['x-auth']).toExist(); // deprecated
        expect(res.headers['x-auth']).toBeTruthy();
        // expect(res.body._id).toExist(); // deprecated
    ...
    request(app)
      ...
      .end((err, res) => {
        ...
        User.findById(users[1]._id).then((user) => { // search user in database
          expect(user.tokens[1]).toMatchObject({ // DEPRECATED: toInclude
            access: 'auth',
